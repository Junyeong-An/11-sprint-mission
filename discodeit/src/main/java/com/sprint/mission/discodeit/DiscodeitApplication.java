...
public class DiscodeitApplication {
    ...
    private static void testUserService(UserService userService) {
        ...
        System.out.println("등록 " + user1.getName() + ", " + user2.getName());

        UUID userId = user1.getId();
        User foundUser = userService.findUser(userId);
        System.out.println("조회-단건 " + foundUser.getId() + " / " + foundUser.getName());
        ...
        System.out.println("수정 데이터 조회 " + updated.getName());
    ...
    private static void testChannelService(ChannelService channelService) {
        ...
        System.out.println("등록 " + channel1.getName() + ", " + channel2.getName());

        UUID channelId = channel1.getId();
        Channel foundChannel = channelService.findChannel(channelId);
        System.out.println("조회-단건 " + foundChannel.getId() + " / " + foundChannel.getName());
