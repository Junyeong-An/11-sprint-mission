...
public class BinaryContentController {
    ...
    public BinaryContentResponse findByQuery(@RequestParam UUID binaryContentId) {
    ...
    public BinaryContentDownloadResponse downloadAll(@RequestParam List<UUID> ids) {
        return binaryContentService.downloadAll(ids);
    }

    @RequestMapping(method = RequestMethod.GET)
    public List<BinaryContentResponse> findAllByIdIn(@RequestParam("binaryContentIds") List<UUID> binaryContentIds) {
